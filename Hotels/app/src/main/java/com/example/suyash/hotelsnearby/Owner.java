...
//        tvTime = (TextView) findViewById(R.id.tvTime);
            ...
            case MY_PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION: {
                ...
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    try {
                        ...
                        Toast.makeText(Owner.this, "SecurityException:\n" + e.toString(), Toast.LENGTH_LONG).show();
                    }
                } else {
                    Toast.makeText(Owner.this, "Permission denied!", Toast.LENGTH_LONG).show();
                }
                return;
            }
        }
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        Toast.makeText(Owner.this, "onConnectionFailed: \n" + connectionResult.toString(),
...
//        tvTime.setText(DateFormat.getTimeInstance().format(loc.getTime()));
        Toast.makeText(Owner.this, Double.toString(loc.getLatitude()) + "  " + Double.toString(loc.getLongitude()), Toast.LENGTH_LONG).show();
    }
